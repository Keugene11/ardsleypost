  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-5 bg-bg">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="bg-bg-card border border-border rounded-2xl px-6 py-8">
          <h2 className="text-[22px] font-bold tracking-tight text-text mb-2">
            Welcome
          </h2>
          <p className="text-[14px] text-text-muted mb-6">
            Sign in to post, comment, and connect with your neighbors.
          </p>
